 ...
 * @class FLMenuModule
 */
class CardMenuModule extends FLBuilderModule {
	...
	public function __construct()
	{
		parent::__construct(array(
			'name'          	=> __('Card Menu', 'fl-builder'),
			'description'   	=> __('Renders a WordPress menu as cards.', 'fl-builder'),
			'category'      	=> __('Advanced Modules', 'fl-builder'),
			'dir'           => FL_MODULE_CARD_MENU_DIR . 'card-menu/',
			'url'           => FL_MODULE_CARD_MENU_URL . 'card-menu/',
 ...
 */
FLBuilder::register_module('CardMenuModule', array(
	'general'       => array( // Tab
		...
		'sections'      => array( // Tab Sections
			'general'       => array( // Section
				...
				'fields'        => array( // Section Fields
					'menu' => CardMenuModule::_get_menus(),
					'menu_layout' => array(
					    'type'          => 'select',
...
class Card_Menu_Menu_Module_Walker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $class_names = ' class="col-md-4 ' . esc_attr( $class_names ) . $submenu .'"';
        ...
        $attributes .= ! empty( $item->url ) ? ' href="' . esc_attr( $item->url ) .'"' : '';
				$attributes .= ! empty( $item->classes ) ? ' class="btn btn-outline-primary btn-block"' : '';
